...
const SupplierCardSkeleton = () => (
  ...
  ">
    ...
    <div className="absolute top-2 right-2 transform translate-x-7 -translate-y-1/2 size-10 rounded-full bg-gray-300" />
    <div className="absolute top-2 right-2 transform translate-x-7 translate-y-6 size-10 rounded-full bg-gray-300" />
